            ...
            <div className="col-md-6 col-lg-6 col-xl-6 col-sm-12">
              <div className="card1">
                <div className="row border-line">
                    ...
                    <img
                      src="https://wordologybymbr.wordpress.com/wp-content/uploads/2020/07/contact-me.jpg"
                      alt="contact"
                      className="image"
                    />
            ...
            <div className="col-lg-6 col-md-6">
                ...
                <div className="card2 d-flex card border-0 px-4 py-5">
                  <div className="row">
                    ...
                    <h6>
  Contact With
  <a href="https://www.linkedin.com/in/adnan-shabbir-b99187238" target="_blank" rel="noopener noreferrer">
    <BsLinkedin color="blue" size={30} className="ms-2" />
  </a>
  <a href="https://github.com/AdnanShabbir-code" target="_blank" rel="noopener noreferrer">
    <BsGithub color="black" size={30} className="ms-2" />
  </a>
  <a href="mailto:shabbiradnan7762@gmail.com" target="_blank" rel="noopener noreferrer">
